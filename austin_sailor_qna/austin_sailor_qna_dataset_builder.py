...
class AustinSailorQna(tfds.core.GeneratorBasedBuilder):
    """
    DatasetBuilder for Austin Sailor with added QnA Pairs.
    """
    VERSION = tfds.core.Version('1.0.0')
    RELEASE_NOTES = {'1.0.0': 'Initial release.'}

    def __init__(self, *args, **kwargs):
        self.oxe_dataset_name = "austin_sailor_dataset_converted_externally_to_rlds"
