...
class NyuFrankaPlayQna(tfds.core.GeneratorBasedBuilder):
    """
    DatasetBuilder for NYU Franka Play with added QnA Pairs.
    """
    VERSION = tfds.core.Version('1.0.0')
    RELEASE_NOTES = {'1.0.0': 'Initial release.'}

    def __init__(self, *args, **kwargs):
        self.oxe_dataset_name = "nyu_franka_play_dataset_converted_externally_to_rlds"
