...
class BerkeleyCableRoutingQna(tfds.core.GeneratorBasedBuilder):
    """
    DatasetBuilder for Berkeley Cable Routing with added QnA Pairs.
    """
    VERSION = tfds.core.Version('1.0.0')
    RELEASE_NOTES = {'1.0.0': 'Initial release.'}

    def __init__(self, *args, **kwargs):
        self.oxe_dataset_name = "berkeley_cable_routing"
