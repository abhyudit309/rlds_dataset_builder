...
class StanfordHydraQna(tfds.core.GeneratorBasedBuilder):
    """
    DatasetBuilder for Stanford Hydra with added QnA Pairs.
    """
    VERSION = tfds.core.Version('1.0.0')
    RELEASE_NOTES = {'1.0.0': 'Initial release.'}

    def __init__(self, *args, **kwargs):
        self.oxe_dataset_name = "stanford_hydra_dataset_converted_externally_to_rlds"
