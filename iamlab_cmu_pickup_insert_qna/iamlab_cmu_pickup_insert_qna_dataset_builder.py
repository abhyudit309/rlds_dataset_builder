...
class IamlabCmuPickupInsertQna(tfds.core.GeneratorBasedBuilder):
    """
    DatasetBuilder for IAM Lab CMU Pickup Insert with added QnA Pairs.
    """
    VERSION = tfds.core.Version('1.0.0')
    RELEASE_NOTES = {'1.0.0': 'Initial release.'}

    def __init__(self, *args, **kwargs):
        self.oxe_dataset_name = "iamlab_cmu_pickup_insert_converted_externally_to_rlds"
